...
export default {
  ...
  'sqlBuilder.selectDatabase': 'Select database',
  ...
  'sip.flows': 'SIP Flows',
  'sip.noFlows': 'No SIP flows found',
  'sip.selectFlow': 'Select a flow on the left',
  'sip.noMessages': 'No messages in this flow',
  'sip.ladder': 'Message Ladder',
  'sip.msgDetail': 'Message Detail',
  'sip.messages': 'messages',
  'sip.dirOut': '↑ Out',
  'sip.dirIn': '↓ In',
  'sip.from': 'From',
  'sip.to': 'To',
  'sip.size': 'Size',
  'sip.live': 'Live',
  'sip.startLive': 'Start Live',
  'sip.stopLive': 'Stop Live',
  'sip.epMessages': 'Messages for {ep}',
  'sip.nodeName': 'Node',
  'sip.loadError': 'Load failed, please retry',
  'sip.exportSuccess': 'Export successful',
  'footer.queryMode': 'Query Mode',
  'footer.fullMode': 'Full Mode',
  'footer.switchFull': 'Switch to Full Mode',
  'footer.switchQuery': 'Switch to Query Mode',
  ...dashboard,
  ...settings,
  ...menu,
  ...playground,
